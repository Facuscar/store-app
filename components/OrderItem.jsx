...
const OrderItem = ({ item }) => {
    ...
    const { handleEditAmount, handleDeleteProduct } = useStore();
    ...
    return (
        <div className="shadow p-5 mb-3 flex gap-10 items-center">
            ...
            <div>
                <button 
                    type="button" 
                    className="gap-2 bg-sky-700 flex px-5 py-2 text-white rounded-md font-bold uppercase shadow-md w-full"
                    onClick={() => handleEditAmount(item.id)}
                >
                ...
                <button 
                    type="button" 
                    className="gap-2 bg-red-700 flex mt-5 px-5 py-2 text-white rounded-md font-bold uppercase shadow-md w-full"
